...
const ProductPage = () => (
  <SideBarDash>
    <div className="flex flex-col ">
      <p className="text-4xl text-pink-600 font-bold">Product</p>
      <div className="flex justify-end mt-20 mb-6">
        <button className="">
          <a
            className="flex justify-center py-2 item-center w-40 h-9 bg-pink-600 text-white rounded-lg  text-sm"
      ...
      <table className="overflow-hidden rounded text-sm text-left text-black w-full">
        <thead className="text-xs text-pink-600 uppercase bg-gray-200">
          <tr className="">
        ...
        <tbody>
          <tr className="bg-white border-b ">
            ...
            <td className="px-6 py-4">Converse Run Star Black</td>
