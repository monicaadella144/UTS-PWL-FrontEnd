...
const Home = () => {
  const [products] = useState([
    { id: 1, image:"Images/product1.jpg", name: "Converse Run Star Black", price: 1000000 },
    { id: 2, image:"Images/product2.jpg", name: "Nike", price: 599000 },
    { id: 3, image:"Images/product3.jpg", name: "Air Jordan Shoes", price: 899000 },
    { id: 4, image:"Images/product4.jpg", name: "Converse Run Star Pink", price: 1000000 },
    { id: 5, image:"Images/product5.jpg", name: "Sneakers Pink", price: 799000 },
    { id: 6, image:"Images/product6.jpg", name: "Air Jordan Black", price: 1500000 },
    { id: 7, image:"Images/product7.jpg", name: "Air Jordan Cream", price: 2000000 },
    { id: 8, image:"Images/product8.jpg", name: "Nike", price: 699000 },
    { id: 9, image:"Images/product9.jpg", name: "Converse Low", price: 599000 },
    { id: 10, image:"Images/product10.jpg", name: "Vans Low", price: 8990000 },
    { id: 11, image:"Images/product11.jpg", name: "Converse White", price: 599000 },
    { id: 12, image:"Images/product12.jpg", name: "Vans", price: 999000 },
      ...
      <div className="pt-[60px] container m-auto flex h-screen overflow-hidden">
        <div className="left w-[70%] h-full ">
          <div className="head mb-[20px]">
            ...
            Get ready to walk in style with our new arrivals! Explore a wide range of trendy shoes, and dont miss out on our limited-time offer for free shoe care products with every purchase.
            </div>
          </div>
        ...
        <div className="right w-[30%] px-3 flex items-center justify-center ">
          <div className="keranjang produk bg-white h-[95%] w-full rounded-lg p-2 py-3 flex flex-col justify-between shadow-lg">
            ...
            <div className="bottom ">
              ...
              <button className="bg-[#cca467] text-white w-full p-2 hover:bg-[#46C5A9]">Checkout</button>
            </div>
          </div>
        </div>
      </div>
